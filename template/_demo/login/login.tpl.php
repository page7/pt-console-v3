...
<body>
    ...
    <div class="container">
        ...
        <form class="form-signin" role="form" method="POST">
            <h2 class="form-signin-heading"><?=__('Please sign in', 'console') ?></h2>
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="remember" value="1"> <?=__('Remember me', 'console') ?>
                </label>
            </div>
            <button class="btn btn-lg btn-primary btn-block" type="button" onclick="login()"><?=__('Sign in', 'console') ?></button>
        </form>
